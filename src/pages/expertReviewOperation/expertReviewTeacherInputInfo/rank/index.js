...
export default {
    data() {
        return {
            ...
            performanceCriteriaTeacherChooseName: null,
            dataSource: [],
            tableData: [],
            teacherInfo: {
                teacherName: null,
    ...
    methods: {
        init() {
            this.rankReviewId = this.$route.query.reviewId
            this.teacherSid = this.$route.query.teacherSid
            this.teacherId = this.$route.query.teacherId
            this.performanceCriteriaId = this.$route.query.performanceCriteriaId
            this.getList()
        },
        ...
        getList() {
            XHR.Axios_$$getTeacherApplyInfo({
                sid: this.teacherSid,
                id: this.teacherId,
                rankReviewId: this.rankReviewId
            }).then(async result => {
                console.log(result)
                let data = result.data
                let info = data.info
                let apply = info.teacherApply
                this.performanceCriteriaTeacherChooseName = apply.performanceCriteriaTeacherChooseName
            })
            XHR.Axios_$$getInfo({
                id: this.teacherId,
                type: 2
