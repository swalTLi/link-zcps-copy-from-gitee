      ...
      <div>
        ...
        >
          <span slot="tags" slot-scope="text">
            <a-tag
              v-for="tag in text.text"
              :key="tag"
              :color="tag == 1 ? 'green' : 'red'"
            >
              {{ tag ? "开启" : "关闭" }}
            </a-tag>
          </span>
          ...
          <div slot="action" slot-scope="{ record }">
            <a style="margin-right: 8px"> <a-icon :component="svg_user" />报名管理 </a>
            <a style="margin-right: 8px">
              <a-icon :component="svg_excel_export" />开启公示
            </a>
            <a style="margin-right: 8px">
              <a-icon :component="svg_registration" />编辑
            </a>
            <a-popconfirm
              title="确认删除？"
              ok-text="删除"
            ...
            >
              <a style="margin-right: 8px"> <a-icon :component="svg_delete" /> 删除 </a>
            </a-popconfirm>
...
for (let i = 0; i < 3; i++) {
  dataSource.push({
    ...
    num: i * 100 + 12,
    description: "这是一段描述",
    time: "2021-10-12 08:00" + "-" + "2021-10-17 08:00",
