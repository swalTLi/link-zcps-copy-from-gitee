...
// import { type as USER_TYPE } from "@/util/parameras"
// API接口
// import {
//   Axios_$$searchSecondarySectorDepartmentList,
//   Axios_$$addSecondarySectorDepartment,
//   Axios_$$deleteSecondarySectorDepartment,
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      XHR.Axios_$$searchSecondarySectorDepartmentList(this.info).then(_ => {
    ...
    handleEdit(query) {
      console.log(query);
      // 调用接口
      XHR.Axios_$$addSecondarySectorDepartment(query).then(_ => {
    ...
    // 删除指定数据
    deleteRecord(record) {
      XHR.Axios_$$deleteSecondarySectorDepartment(record).then(() =>
        this.getList()
      );
      return this.getList();
