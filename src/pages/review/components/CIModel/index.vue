  ...
  <div>
    ...
    >
      ...
      >
        ...
        <a-form-model-item v-if="level_model.record.pullResearch" label="限制">
          <div
            style="width:100%;display:flex;justify-content:center;align-items:between;"
          >
            <a-table
...
export default {
  ...
  methods: {
    async getList() {
      ...
      await XHR.Axios_$$searchPerformanceRequireList({
        ...this.info,
        id: this.record.id,
      }).then(_ => {
    ...
    // 保存序号按钮
    saveIndex() {
      XHR.Axios_$$addRequireInfoSerialNumber({
                ...
                this.$refs.jtyqForm.validate(valid => {
                  if (valid) {
                    ...
                    XHR.Axios_$$addRequireInfo({
                      ...
                      //   ].requireLevelOne[index].requireLevelTwo;
                      // } else if (level === 1) {
                      //   // this.CI_model.record.requireLevelOne = this.dataSource[
                      //   //   this.CI_model.listIndex
                      //   // ];
                      //   // console.log(this.level_model.record);
                      //   // console.log(
                      //   //   this.CI_model.listIndex,
              ...
              this.$refs.jtyqForm.validate(valid => {
                if (valid) {
                  XHR.Axios_$$addRequireInfo({
                    ...
                    performanceCriteriaId: this.record.id,
                    performanceCriteriaSerialNumberId: this.CI_model.record.id,
