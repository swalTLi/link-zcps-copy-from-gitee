...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      XHR.Axios_$$thirdPartyData_kjc_data_getList(this.info).then(_ => {
    ...
    handleEdit(query) {
      console.log(query);
      // 调用接口
      XHR.Axios_$$thirdPartyData_kjc_data_edit({
        operate: 2,
        type: this.info.type,
        id: query.id,
    ...
    async handleUpload() {
      ...
      await XHR.Axios_$$thirdPartyData_kjc_upload(formData).then(_ => {
        console.log(_);
