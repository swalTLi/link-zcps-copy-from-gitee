  ...
  <a-card :bordered="false">
    <div class="result-success" :bordered="false">
      ...
      <div class="box">
        <div
                class="welcome-link"
                @click="goto('/rank/teacher-rank-loading', item, 'rankReviewId', 1)"
      ...
      <div class="box">
        <div
                class="welcome-link"
                @click="
            goto('/employ/teacher-employ-loading', item, 'rankReviewId', 0)
          "
