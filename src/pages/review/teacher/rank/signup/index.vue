<template>
  <a-card :body-style="{ padding: '24px 32px' }" :bordered="false">
    ...
    >
      ...
      <a-form-model-item label="业绩条件" prop="performanceCriteriaId">
        <a-select
    ...
    <a-result v-if="is_ok" status="success" title="报名成功!">
      <template #extra>
        <a-button
          ...
          type="primary"
          @click="
            nextPage('/rank/teacher-rank-workload', {
              ...$route.query,
            })
          "
          size="large"
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        performanceCriteriaId: [
          { required: true, message: "请选择业绩条件", trigger: "blur" },
        ],
      },
      is_ok: false,
    };
