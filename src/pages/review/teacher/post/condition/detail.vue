<template>
  <a-card :bordered="false">
    ...
    <br />
    <div class="title" v-if="record['chooseCompetition'].length > 0">
      <h5 style="font-weight:bold;margin:20px 0 ;">大创</h5>
    </div>
    <a-table
      ...
      :pagination="false"
    >
      <a-table-column key="name" title="大创" data-index="name" width="300" />
    ...
    <div class="title" v-if="record['chooseProject'].length > 0">
    ...
    <div class="title" v-if="record['chooseResearch'].length > 0">
