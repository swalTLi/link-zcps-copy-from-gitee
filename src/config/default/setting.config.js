...
module.exports = {
  ...
  systemName: "沈阳航空航天大学职级评审系统", //系统名称
  copyright: "2021 link doder", //copyright
  ...
  footerLinks: [
    ...
    { link: "https://pro.ant.design", name: "沈阳航空航天大学" },
    { link: "https://github.com/iczer/vue-antd-admin", icon: "code-sandbox" },
    { link: "https://ant.design", name: "沈阳微拓科技有限公司" },
  ],
};
